...
namespace QuadTree_STARTER
{
	public class Game1 : Game
	{
		...
		/// STUDENTS: Change to true if necessary!
		/// </summary>
		private bool DisableSwirling = false;

		/// <summary>
		/// Should the program always begin with the same set of objects?
		/// </summary>
		private bool StaticStartingObjects = false;
		private int StaticStartingCount = 30;
		...
		private void AddGameObject(Rectangle? rect = null)
		{
			...
			quadTreeRoot.AddObject(gameObj);
		}
